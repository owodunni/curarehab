    ...
    >
      <div>
        <div class="flex items-center text-gray-900">
          <AcademicCapIcon class="h-10 w-10 flex-none text-zinc-500" />
          <div class="ml-4">
            <p class="text-base font-semibold">{$t("common", "title")}</p>
            <p class="mt-1 text-sm">{$t("common", "subtitle")}</p>
          </div>
        </div>
      ...
      >
        ...
        <div class="ml-8 lg:w-64">
          <p class="text-base font-semibold text-gray-900">
            <a href="https://goo.gl/maps/9GKYbdP5qm2y9w8v9">
              <span class="absolute inset-0 sm:rounded-2xl" />
              Skeppsbron 8, 111 21 Stockholm
            </a>
          </p>
